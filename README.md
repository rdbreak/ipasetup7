# Automatic IPA (RHEL 7) server setup powered by Ansible and Vagrant. 
...
1. Create a separate `~/bin` directory and `cd` to it.  (The directory doesn't have to be ~/bin, it can be anything you want.)
2. Use your browser of choice and navigate to https://github.com/rdbreak/ipasetup7, press the green “Clone or download” button then the “Download ZIP” button.
